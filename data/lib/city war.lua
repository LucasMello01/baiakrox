configCW = {timetostart = 500, -- tempo para iniciar o evento em segundos by Absolute
			telpos = {x=157, y=44, z=7}, -- onde aparecerá o teleport
			stats = 201201201701,
			kill = 201201201702,
			death = 201201201703,
			ostime =  201201201704,
			evttime = 20, -- quanto tempo irá rolar o evento
			topleftPos = {x=21, y=464, z=7}, -- canto esquerdo superior
			botrightPos = {x=99, y=520, z=7}, -- canto direito inferior
			templepos = {x=160, y=54, z=7}, -- posição do templo principal
			arenapos = {{x=31, y=472, z=7}, {x=91, y=472, z=7}, {x=94, y=513, z=7}, {x=27, y=514, z=7}}, -- posição dos 4 tronos
...
doBroadcastMessage("City War Será abérta em  " .. self.timetostart .. " Segundos.")
